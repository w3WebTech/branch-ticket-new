...
export default {
  data() {
    return {
      ...
      clientTicketData: { count: 0 }, // Initial empty state for branch ticket data
      clientTicketDataResolved: { count: 0 }, // Initial empty state for branch resolved ticket data
      setTab: 1, // Default tab to be shown
      isCreate: false,
      username: null,
      emailId: null,
    };
